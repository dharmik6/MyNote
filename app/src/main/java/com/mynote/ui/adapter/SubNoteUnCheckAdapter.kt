...
class SubNoteUnCheckAdapter(
    private val context: Context,
    private var list: MutableList<NotesParam.SubNote>,
    private val listener: OnSubNoteCheckedChangeListener

) : RecyclerView.Adapter<SubNoteUnCheckAdapter.ViewHolder>() {

    private val TAG = "SubNoteUnCheckAdapter"
    ...
    class ViewHolder(val binding: NotesSubItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(
            ...
            binding.mainCard.setCardBackgroundColor(Color.parseColor(subNote.color))
    ...
    private fun changeData(listener: OnSubNoteCheckedChangeListener, position: Int, item : NotesParam.SubNote) {
        if (position < list.size) {
            ...
            listener.onSubNoteCheckedChangeListener(subNote)
