...
class BuyingAdapter(private val context: Context, private val list: MutableList<NotesParam> , private val listener : OnLongClickListener) :
    RecyclerView.Adapter<BuyingAdapter.ViewHolder>() {
    var isMenuOpen = false

    lateinit var  binding : NotesItem1Binding

    private val TAG = "BuyingAdapter"

    class ViewHolder(val binding: NotesItem1Binding) : RecyclerView.ViewHolder(binding.root) {

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
         binding = NotesItem1Binding.inflate(LayoutInflater.from(context), parent, false)
